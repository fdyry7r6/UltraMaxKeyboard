...
private constructor(val themeId: Int, @JvmField val mStyleId: Int) {
    ...
    companion object {
        ...
        const val THEME_ULTRAMAX = "ultramax"
        const val THEME_GLASS = "glass"
        const val THEME_NEON_CYBER = "neon_cyber"
        ...
        private fun getThemeColors(themeName: String, themeStyle: String, context: Context, prefs: SharedPreferences, isNight: Boolean): Colors {
            ...
            return when (themeName) {
                ...
                THEME_NEON_CYBER -> DefaultColors(
                    themeStyle,
                    true,
                    "#FF00AA".toColorInt(),
                    "#050510".toColorInt(),
