...
fun getCodeForToolbarKey(key: ToolbarKey) = Settings.getInstance().getCustomToolbarKeyCode(key) ?: when (key) {
    ...
    TOP_TOPY_STUDIO -> KeyCode.TOP_TOPY_STUDIO
}
...
enum class ToolbarKey {
    ...
    PAGE_UP, PAGE_DOWN, FULL_LEFT, FULL_RIGHT, PAGE_START, PAGE_END, BACKGROUND_GATHERING, TOP_TOPY_STUDIO
}
...
val defaultToolbarPref by lazy {
    val default = listOf(SETTINGS, TOP_TOPY_STUDIO, VOICE, CLIPBOARD, UNDO, REDO, SELECT_WORD, COPY, PASTE, LEFT, RIGHT)
