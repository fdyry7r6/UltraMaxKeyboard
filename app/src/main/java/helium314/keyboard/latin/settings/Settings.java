...
public final class Settings implements SharedPreferences.OnSharedPreferenceChangeListener {
   ...
   public static final String PREF_VARIABLE_TOOLBAR_DIRECTION = "var_toolbar_direction";
    ...
    @Nullable public static Drawable readUserBackgroundImage(final Context context, final boolean night) {
        ...
        if (!image.isFile()) {
            // Top Topy Board ships with a cinematic default background. User-selected
            // backgrounds still take priority and can be removed from settings.
            try {
                sCachedBackgroundImages[index] = new BitmapDrawable(
                        context.getResources(),
                        BitmapFactory.decodeResource(context.getResources(), R.drawable.top_topy_background));
