...
object Defaults {
    ...
    const val PREF_THEME_COLORS = KeyboardTheme.THEME_ULTRAMAX
    const val PREF_THEME_COLORS_NIGHT = KeyboardTheme.THEME_ULTRAMAX
    ...
    @JvmField
    val PREF_SPACE_HORIZONTAL_SWIPE = KeyboardActionListener.SwipeAction.SWITCH_LANGUAGE.name
    @JvmField
